// Worker script for background scraping (ESM compatible)
...
export async function scrapeComments(postUrl, cookieFile) {
  let browser;
  ...
  try {
    ...
    const storageState = cookieFile && fs.existsSync(cookieFile)
      ? JSON.parse(fs.readFileSync(cookieFile, 'utf8'))
      : undefined;
